...
from dataset.dataset import load_nc_dataset
from utils.correct_smooth import double_correlation_autoscale
from utils.data_utils import gen_normalized_adjs, evaluate, evaluate_mlpnorm, eval_acc, eval_rocauc, to_sparse_tensor, load_fixed_splits
...
if args.method == 'mlpnorm' or args.method == 'mlpnorm_improve':
...
if args.dataset in ['roman-empire', 'amazon-ratings', 'minesweeper', 'tolokers', 'questions']:
    dataset = Dataset(name=args.dataset,
                      add_self_loops=(args.method in ['GCN', 'GAT', 'GT']),
                      device=device,
    ...
    n = dataset.node_features.shape[0]
    c = dataset.num_targets
